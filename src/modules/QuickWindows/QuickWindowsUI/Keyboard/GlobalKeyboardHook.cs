...
namespace QuickWindows.Keyboard
{
    public class GlobalKeyboardHook : IDisposable
    {
        ...
        public GlobalKeyboardHook()
        {
            ...
            _windowsHookHandle = NativeMethods.SetWindowsHookEx(NativeMethods.WH_KEYBOARD_LL, _hookProc, _user32LibraryHandle, 0);
        ...
        private IntPtr LowLevelKeyboardProc(int nCode, IntPtr wParam, IntPtr lParam)
        {
            ...
            {
                object? o = Marshal.PtrToStructure(lParam, typeof(NativeMethods.LowLevelKeyboardInputEvent));
                NativeMethods.LowLevelKeyboardInputEvent p = (NativeMethods.LowLevelKeyboardInputEvent)o!;
