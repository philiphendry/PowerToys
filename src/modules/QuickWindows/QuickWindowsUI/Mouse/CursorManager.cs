...
namespace QuickWindows.Mouse
{
    public static class CursorManager
    {
        ...
        private const string QuickWindowsCursorName = "Assets\\QuickWindows\\QuickWindows.cur";
        ...
        public static void SetQuickWindowsCursor()
        {
            BackupOriginalCursors();

            var quickWindowsCursorPath = _fileSystem.Path.Combine(AppDomain.CurrentDomain.BaseDirectory, QuickWindowsCursorName);
            ChangeCursor(quickWindowsCursorPath, ArrowRegistryName);
            ChangeCursor(quickWindowsCursorPath, IBeamRegistryName);
        }
